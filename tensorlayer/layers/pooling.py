...
class GlobalMaxPool2d(Layer):
    ...
    def __init__(
        ...
        # operation (customized)
        self.outputs = tf.reduce_max(prev_layer.outputs, axis=[1, 2], name=name,keep_dims=keepdims)
...
class GlobalMeanPool2d(Layer):
    ...
    def __init__(
        ...
        # operation (customized)
        self.outputs = tf.reduce_mean(prev_layer.outputs, axis=[1, 2], name=name,keepdims=keepdims)
